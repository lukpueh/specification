...
the timestamp metadata file.
  ...
  * **3.4**. **Check for a rollback attack.** The version number of the targets
  ...
  * **3.6**. **Persist snapshot metadata.** The client MUST write the file to
...
snapshot metadata file.
  ...
  * **4.5**. **Persist targets metadata.** The client MUST write the file to
